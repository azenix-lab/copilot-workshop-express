...
var AuthContoller = /** @class */ (function () {
    function AuthContoller() {
    }
    AuthContoller.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, userRepository, user, isPasswordValid, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        isPasswordValid = encrypt_1.encrypt.comparepassword(password, user.password);
                        if (!isPasswordValid) {
